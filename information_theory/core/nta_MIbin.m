function [ results ] = nta_MIbin(data1,data2,cfg)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if numbin==0
    numbin1                     =   nta_freeddiac(data1);
    numbin2                     =   nta_freeddiac(data2);
    numbin                      =   min([numbin1 numbin2]);
end
...
[N,Xedges,Yedges,binX,binY]     =   histcounts2(data1,data2,[numbin numbin]);
